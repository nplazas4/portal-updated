...
class ChartsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'EXCEL_CHART' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'EXCEL_CHART' => 'Lorem ipsum dolor sit amet',
                'PROJECT_CODE' => 1
            ],
        ];
        parent::init();
